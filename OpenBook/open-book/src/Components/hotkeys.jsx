function HotKeys() {
  ...
  return (
    <div className="settings-section">
      <p className="settings-section-header">Hot Keys</p>
      <p className="mb-[-10px] text-white text-sm">
        Use hot keys to place orders quickly. They execute on the market you're
        viewing and are not market specific.
      </p>
      <div className="account-settings">
        <p className="mb-3 text-white text-sm">Create your first hot key</p>
